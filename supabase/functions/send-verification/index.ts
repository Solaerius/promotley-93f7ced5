...
const MAIL_FROM = Deno.env.get("MAIL_FROM") || "Promotely <noreply@support.promotley.se>";
const MAIL_REPLY_TO = Deno.env.get("MAIL_REPLY_TO") || "Promotely <noreply@support.promotley.se>";
