...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div 
    ref={ref} 
    className={cn(
      "rounded-xl border-2 bg-card text-card-foreground shadow-card transition-all duration-300 ease-out hover:shadow-card-hover [border-color:var(--outline-subtle)]",
      className
    )} 
    {...props} 
  />
