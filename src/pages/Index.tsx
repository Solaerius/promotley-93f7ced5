            ...
            <div className="text-center sm:text-left md:text-right sm:col-span-2 md:col-span-1">
              ...
              <div className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
                ...
                <div className="mt-3 md:mt-4 flex gap-3 md:gap-4 justify-center md:justify-end">
                  <a href="https://www.instagram.com/promotley.se" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-all duration-300 hover:scale-110 animate-fade-in opacity-0" style={{
                  animationDelay: "0ms",
                  ...
                  <a href="https://www.tiktok.com/@promotley.se" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-all duration-300 hover:scale-110 animate-fade-in opacity-0" style={{
